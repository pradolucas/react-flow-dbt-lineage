...
// Imports our custom component that renders the tables.
            ...
            lineageInfo.lineage.forEach(sourceString => {
                ...
                if (!edges.has(edgeId)) {
                    edges.set(edgeId, {
                        ...
                        animated: true, // The edge will have a flow animation
...
function Flow() {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [setNodes, setEdges]); // React asks to include the setters here.
